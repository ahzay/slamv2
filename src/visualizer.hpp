...
void
Visualizer::add_points(Eigen::Matrix<double, Eigen::Dynamic, 2> pts,
                       string color)
{
  // of << "unset border\n unset xtics\n unset ytics\n";
...
void
Visualizer::add_ellipse(Eigen::VectorXd p)
{
  of << "xc=" << p(0) << endl
     << "yc=" << p(1) << endl
     << "th=" << p(2) << endl
...
void
Visualizer::add_segment(Eigen::VectorXd p, Eigen::VectorXd t)
{
